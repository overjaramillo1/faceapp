...
export const AccountPopover = (props) => {
  ...
  const handleSignOut = async () => {
    console.log('AccountPopover---authContext :>> ', authContext);
    onClose?.();
...
console.log('authSkipped :>> ', authSkipped);
    ...
    try {
      ...
      console.log('papover 45au :>> ',  authContext);
      //        {authContext.user.idToken.payload.email}
    ...
    >
      ...
      >
        ...
        <Typography
          ...
          variant="body2"
        >
        Email: {authContext.user.idToken.payload.email}
        </Typography>
      </Box>
      <MenuList
        disablePadding
